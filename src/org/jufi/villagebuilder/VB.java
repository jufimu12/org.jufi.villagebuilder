...
public class VB extends Engine {
	...
	private void initTex() {
		try {
			...
			tex_goods[3] = ResourceLoader.loadTexture("res/img/bmat3.png");
			...
			tex_goods[11] = ResourceLoader.loadTexture("res/img/bmat4.png");
			tex_goods[12] = ResourceLoader.loadTexture("res/img/bmat5.png");
			tex_goods[13] = ResourceLoader.loadTexture("res/img/bspc3.png");
			...
			tex_bmspc_2 = ResourceLoader.loadTexture("res/img/bspc2.png");
			...
			BUniversity.tex_locked[0] = tex_goods[3];
			BUniversity.tex_locked[1] = tex_bmfod_3;
			BUniversity.tex_locked[2] = tex_goods[13];
		} catch (IOException e) {
	...
	private void initTech() {
		...
		thlvlup[1] = new Runnable() {
			...
			public void run() {
				bmenu_spc.addItem(new DiscMenuItem() {
					@Override
					public void render() {
						renderDynDiscMenuIconWithTexture(tex_bmspc_2, 19);
					}
					@Override
					public void run() {
						sb = 19;
		...
		tech[1] = new Runnable[3];
		tech[1][0] = new Runnable() {
			@Override
			public void run() {
				bmenu_mat.addItem(new DiscMenuItem() {
					@Override
					public void render() {
						renderDynDiscMenuIconWithTexture(tex_goods[12], 16);
					}
					@Override
					public void run() {
						sb = 16;
				...
				bmenu_mat.addItem(new DiscMenuItem() {
					@Override
					public void render() {
						renderDynDiscMenuIconWithTexture(tex_goods[11], 17);
					}
					@Override
					public void run() {
						sb = 17;
				...
				bmenu_mat.addItem(new DiscMenuItem() {
					@Override
					public void render() {
						renderDynDiscMenuIconWithTexture(tex_goods[3], 18);
					}
					@Override
					public void run() {
						sb = 18;
		...
		tech[1][2] = new Runnable() {
			@Override
			public void run() {
				bmenu_spc.addItem(new DiscMenuItem() {
					@Override
					public void render() {
						renderDynDiscMenuIconWithTexture(tex_goods[13], 20);
					}
					@Override
					public void run() {
						sb = 20;
